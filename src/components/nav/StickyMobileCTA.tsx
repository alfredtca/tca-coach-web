 ...
 *
 * Light-mode surface to match the parent brand: paper bg with a soft top
 * rule and ink-fill primary button.
 */
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "border-t border-rule/70 bg-paper/[0.95] backdrop-blur-md",
    ...
    >
      <div className="mx-auto flex max-w-wide items-center gap-4 px-5 py-3">
        <div className="flex min-w-0 flex-col">
          ...
          <span className="text-ui text-ink leading-tight">
            Open the coach room
          </span>
        </div>
        <Link
          ...
          className={cn(
            "ml-auto inline-flex h-11 shrink-0 items-center gap-2 bg-ink px-5 text-[12px] font-medium uppercase tracking-[0.16em] text-paper",

    ...
    <Section tone="paper" pad="default">
      <div className="grid gap-14 lg:grid-cols-12 lg:gap-16">
        ...
        <div className="lg:col-span-7">
          ...
          <Reveal delay={300}>
            <div className="mt-12 grid gap-px border border-ink/15 bg-ink/10 md:grid-cols-2">
              <div className="bg-ink p-8">
                <p className="eyebrow text-coolGrey">Teaches</p>
                <p className="display mt-5 text-h2 tracking-[0.02em] text-bone">
              ...
              <div className="bg-ink p-8">
                <p className="eyebrow text-coolGrey">Represents</p>
                <p className="display mt-5 text-h2 tracking-[0.02em] text-bone">
                  Agency X Talent
                </p>
                <p className="mt-3 text-ui text-coolGrey-soft pretty">
